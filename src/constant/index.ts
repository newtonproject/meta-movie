...
export const IPFS_GATEWAY_HOST = "ipfs.devnet.newtonproject.org";
...
export const NETWORKS = {
  ...
  HecoMainNet: {
    ...
    subgraphUri:
      "https://gql-nft-heco.cloud.diynova.com/subgraphs/name/NewtonNFT/NFT",
    bearBrickAddress: "0x8215e1464cef8575edd81d80ceee9077d5c7c2b3",
    chineseCharactorAddress: "0x1774253cfaa39015fa5e7c4c6a0deb8c1a994937",
    currencySymbol: "HT",
    contract: {
...
const network =
  parseInt(TARGET_CHAINID) === 1012 ? "NewChainMainNet" : "NewChainTestNet";
